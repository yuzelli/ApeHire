...
public class JobAndCompanyC implements Serializable {
    ...
    private JobAndCompany.CompanyBean company;

    public JobAndCompany.CompanyBean getCompany() {
        return company;
    }

    public void setCompany(JobAndCompany.CompanyBean company) {
